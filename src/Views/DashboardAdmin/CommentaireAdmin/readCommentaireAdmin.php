    ...
    <div class="card" style="color: black;">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-center">
                <a href="<?= HOME_URL . 'dashboardAdmin/updateCommentaire?Id_Utilisateur=' . $commentaire->getIdUtilisateur() . '&Id_Article=' . $commentaire->getIdArticle() ?>" class="btn btn-primary my-3">Modifier le commentaire</a>
